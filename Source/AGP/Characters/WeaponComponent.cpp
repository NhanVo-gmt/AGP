...
bool UWeaponComponent::FireImplementation(const FVector& BulletStart, const FVector& FireAtLocation,
	FVector& OutHitLocation, int& HitTarget)
{
...
void UWeaponComponent::FireVisualImplementation(const FVector& BulletStart, const FVector& HitLocation, const int& HitTarget)
{
...
void UWeaponComponent::ServerFire_Implementation(const FVector& BulletStart, const FVector& FireAtLocation)
{
	FVector HitLocation;
	int HitTarget = 0;
	if (FireImplementation(BulletStart, FireAtLocation, HitLocation, HitTarget))
	{
		MulticastFire(BulletStart, HitLocation, HitTarget);
	}
}

void UWeaponComponent::MulticastFire_Implementation(const FVector& BulletStart, const FVector& HitLocation, const int& HitTarget)
{
	FireVisualImplementation(BulletStart, HitLocation, HitTarget);
}
