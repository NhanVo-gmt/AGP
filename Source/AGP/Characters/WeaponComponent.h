...
private:
	...
	bool FireImplementation(const FVector& BulletStart, const FVector& FireAtLocation, FVector& OutHitLocation, int& HitTarget);
	void FireVisualImplementation(const FVector& BulletStart, const FVector& HitLocation, const int& HitTarget);
	UFUNCTION(NetMulticast, Unreliable)
	void MulticastFire(const FVector& BulletStart, const FVector& HitLocation, const int& HitTarget);
